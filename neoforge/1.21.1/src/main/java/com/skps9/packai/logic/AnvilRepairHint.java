...
public final class AnvilRepairHint {
    ...
    private static List<Ingredient> candidates() {
        ...
        add(out, ArmorMaterials.LEATHER.value().repairIngredient().get());
        add(out, ArmorMaterials.CHAIN.value().repairIngredient().get());
        add(out, ArmorMaterials.IRON.value().repairIngredient().get());
        add(out, ArmorMaterials.GOLD.value().repairIngredient().get());
        add(out, ArmorMaterials.DIAMOND.value().repairIngredient().get());
        add(out, ArmorMaterials.NETHERITE.value().repairIngredient().get());
        add(out, ArmorMaterials.TURTLE.value().repairIngredient().get());
