...
public final class ItemIndexCacheCheck {
    ...
    public static void main(String[] args) throws Exception {
        List<String> modsA = List.of("jei@10", "minecraft@1.19.2", "packai@0.1.5");
        List<String> modsB = List.of("jei@10", "minecraft@1.19.2", "packai@0.1.6");
        ...
        assert fpA.equals(ItemIndexCache.fingerprintMods(List.of("packai@0.1.5", "jei@10", "minecraft@1.19.2")));

        ItemIndexCache.Meta want =
                new ItemIndexCache.Meta("1.19.2", "forge", "zh_tw", fpA);
        ItemIndexCache.Meta same =
                new ItemIndexCache.Meta("1.19.2", "forge", "zh_tw", fpA);
        ItemIndexCache.Meta lang =
                new ItemIndexCache.Meta("1.19.2", "forge", "en_us", fpA);
        ItemIndexCache.Meta mods =
                new ItemIndexCache.Meta("1.19.2", "forge", "zh_tw", fpB);
        ...
        ItemIndexCache.Meta noJei =
                new ItemIndexCache.Meta("1.19.2", "forge", "zh_tw", fpA, false);
        ItemIndexCache.Meta withJei =
                new ItemIndexCache.Meta("1.19.2", "forge", "zh_tw", fpA, true);
        ...
        assert key.contains("1.19.2");
        assert key.contains("forge");
        ...
        assert ItemIndexCache.parseJson("{\"v\":0,\"mc\":\"1.19.2\",\"entries\":[]}").entries().isEmpty();
