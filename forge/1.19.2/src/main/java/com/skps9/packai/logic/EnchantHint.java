...
public final class EnchantHint {
     ...
     * Forge 1.19.2: ForgeRegistries.ENCHANTMENTS + isAllowedOnBooks + canEnchant.
     */
        ...
        try {
            for (net.minecraft.world.item.enchantment.Enchantment e
                ...
                try {
                    ...
                    if (e.isAllowedOnBooks() && e.canEnchant(stack)) {
                        String name = net.minecraft.network.chat.Component.translatable(e.getDescriptionId())
                                .getString();
                        String eff = curatedEffect(e.getDescriptionId(), kindForEnchant(e, stack), replyLang);
    ...
    private static String kindForEnchant(net.minecraft.world.item.enchantment.Enchantment e,
        ...
        if (item instanceof net.minecraft.world.item.ArmorItem) {
            // 1.19.2: ArmorItem.getSlot() — no Type inner class yet
            switch (((net.minecraft.world.item.ArmorItem) item).getSlot()) {
                case HEAD:
                    return "helmet";
                case CHEST:
                    return "chest";
