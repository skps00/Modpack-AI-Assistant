...
public final class PackAiConfig {
     ...
     */
    public static final ForgeConfigSpec.BooleanValue ASK_TRACE_JSONL;
    /**
    ...
    public static final ForgeConfigSpec.BooleanValue ALLOW_WEB_SEARCH;
    public static final ForgeConfigSpec.ConfigValue<String> TAVILY_API_KEY;
    public static final ForgeConfigSpec.ConfigValue<String> SERPER_API_KEY;
    public static final ForgeConfigSpec.ConfigValue<String> SIDEBAR_SIDE;
    /** Which obtain pathway to emphasize: craft | quest | loot | balanced. */
    public static final ForgeConfigSpec.ConfigValue<String> PREFER_OBTAIN;
    /**
     * Semicolon-separated JEI RecipeType UIDs in display priority (first = highest).
     * Empty = use preferObtain heuristic order.
     */
    public static final ForgeConfigSpec.ConfigValue<String> RECIPE_CATEGORY_ORDER;
    /** Semicolon-separated JEI RecipeType UIDs hidden from JEI summary / recipe cards. */
    public static final ForgeConfigSpec.ConfigValue<String> RECIPE_CATEGORY_HIDDEN;
    /**
     * How to attach NBT/component extras on JEI ingredient labels for the LLM:
     * auto (default) | always | never.
     */
    public static final ForgeConfigSpec.ConfigValue<String> INGREDIENT_NBT_POLICY;
    /**
     ...
     */
    public static final ForgeConfigSpec.ConfigValue<String> INGREDIENT_NBT_SKIP_PATTERNS;
    /**
     ...
     */
    public static final ForgeConfigSpec.ConfigValue<String> INGREDIENT_NBT_KEEP_PATTERNS;
    /** When true, digit-bearing tooltip lines may be treated as requirements (usually noisy). */
    public static final ForgeConfigSpec.BooleanValue INGREDIENT_TOOLTIP_AS_REQ;
    /**
     * When true, Pack AI may surface FTB/Heracles quests marked hide/invisible/deps-gated.
     * Default false (anti-spoiler).
     */
    public static final ForgeConfigSpec.BooleanValue SHOW_HIDDEN_QUESTS;
    /** When true, attach “related missions” / quest facts under answers. */
    public static final ForgeConfigSpec.BooleanValue ATTACH_RELATED_QUESTS;
    /**
     ...
     */
    public static final ForgeConfigSpec.BooleanValue QUEST_MATCH_HOTBAR;
    /**
     ...
     */
    public static final ForgeConfigSpec.ConfigValue<String> RECIPE_CARD_MIRROR_CATEGORIES;
    /**
    ...
    public static final ForgeConfigSpec.BooleanValue MODULAR_TOOL_SINGLE_ITEM;
    /**
     ...
     */
    public static final ForgeConfigSpec.ConfigValue<String> RECIPE_BACKEND;
    /**
     * PackIndex nearby snippet: lines before/after first item-id / hint hit (not file head).
     * Default 30; clamped 5–100.
     */
    public static final ForgeConfigSpec.IntValue PACK_INDEX_CLIP_RADIUS;
    /**
     ...
     */
    public static final ForgeConfigSpec.ConfigValue<String> GUIDEBOOK_SCOPE;
    /**
     ...
     */
    public static final ForgeConfigSpec.BooleanValue GUIDEBOOK_RELATED_HOP;
    /**
     ...
     */
    public static final ForgeConfigSpec.ConfigValue<String> ASK_PURPOSE_ORDER;
