...
public class PackAiSettingsScreen extends Screen {
    ...
    private void initAsk(int left, int y, int w, int half) {
        ...
        this.addRenderableWidget(CycleButton.<String>builder(
                ...
                .withTooltip(v -> WidgetCompat.tipLines("packai.settings.tooltip.guidebook_scope"))
                .create(left + half + 8, y, half, 20,
        ...
        this.addRenderableWidget(CycleButton.<Boolean>builder(
                ...
                .withTooltip(v -> WidgetCompat.tipLines("packai.settings.tooltip.guidebook_related"))
                .create(left, y, half, 20,
        ...
        this.addRenderableWidget(CycleButton.<String>builder(
                ...
                .withTooltip(v -> WidgetCompat.tipLines("packai.settings.tooltip.ask_purpose_order"))
                .create(left + half + 8, y, half, 20,
        ...
        this.addRenderableWidget(CycleButton.<String>builder(
                ...
                .withTooltip(v -> WidgetCompat.tipLines("packai.settings.tooltip.ask_native_tools"))
                .create(left, y, w, 20,
